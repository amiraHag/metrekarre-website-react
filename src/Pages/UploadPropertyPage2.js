...
const UploadPropertyPage = () => {
    ...
    const [delivery, setSelectedDeliveryDate] = useState(''); // State for Delivery Date
    const [address, setAddress] = useState(''); // State for address
    const [carredor, setSelectedCarreDor] = useState('');
    ...
    const [core_and_shell, setSelectedCoreandShell] = useState('');
    ...
    return (<div>
        ...
        <ContactCard>
            ...
            >
                ...
                <TwoFieldsRow>
                    <ReusableTextField className="textfield" id="phoneNumber" label="Phone Number" onChange={(e) => handleInputChange(e, setPhoneNumber)} />
                ...
                <ContactCard  className={`${property_info_class}`}> 
                    ...
                    <ReusableTextField
                        ...
                        <ReusableTextField
                            ...
                            id="DeliveryDate"
                            label="Delivery Date"
                            onChange={(e) => handleInputChange(e, setSelectedDeliveryDate)}
                            value={delivery}
                        />
                       ...
                       <TwoFieldsRow>
                        ...
                        <Dropdown
                                    className="dropdown"
                                    onChange={(e) => handleInputChange(e, setSelectedCarreDor)}
                                    value={carredor}>
                                    <option value="">Carre D'or?</option>
                    ...
                    <Dropdown
                        ...
                        <option value="">Style</option>
                            ...
                            <TwoFieldsRow>
                                ...
                                <Dropdown
                                    className="dropdown"
                                    onChange={(e) => handleInputChange(e, setSelectedParkings)}
                                    value={parking}>
                                    {parkings.map((parkingItem) => (
                                        <option key={parkingItem} value={parkingItem}>
                                            {parkingItem}
                                        </option>
                                    ))}
                        ...
                        />
                         <Dropdown
                                   ...
                                   onChange={(e) => handleInputChange(e, setSelectedWithConstruction)}
                                    ...
                                    <option  value="">With Construction?</option>
                                    <option  value="Yes">Yes</option>
                                    <option  value="No">No</option>
                ...
                <ContactCard  className={`${property_info_class} ${property_info_land_class}`}> 
                    ...
                    <ReusableTextField
                            ...
                            id="Plus"
                            label="Plus"
                            onChange={(e) => handleInputChange(e, setPlusDesc)}
                            value={plus_desc}
                        />
                        ...
                        <ReusableTextField
                            ...
                            id="Minus"
                            label="Minus"
                            onChange={(e) => handleInputChange(e, setminusDesc)}
                            value={minus_Desc}
                        />
            ...
            <ContactCard  className={`${property_info_class} ${property_info_commercial_class}`}> 
                   ...
                   <Dropdown
                                   ...
                                   onChange={(e) => handleInputChange(e, setSelectedUndergroundParking)}
                                    ...
                                    <option   value="">Underground Parking</option>
                                    <option   value="Yes">Yes</option>
                                    <option   value="No">No</option>
                            ...
                            onChange={(e) => handleInputChange(e, setSelectedCoreandShell)}
